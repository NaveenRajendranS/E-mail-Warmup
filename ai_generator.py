...
- Body: exactly 2-3 lines, very short
...
- asking if they are available for a quick call to dicuss about the bug 
...
Pick a different intent and wording every time. Avoid repeating previous patterns.
